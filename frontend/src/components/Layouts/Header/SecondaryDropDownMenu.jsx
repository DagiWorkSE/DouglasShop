    ...
    const navs = [
        {
            ...
            redirect: "https://www.Douglasshop.com/communication-preferences/push",
        },
        {
            title: "Sell on Douglasshop",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.Douglasshop.com/sell-online",
        },
        {
            title: "24x7 Customer Care",
            icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Douglasshop.com/helpcentre",
        },
        {
            title: "Advertise",
            icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://advertising.Douglasshop.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.Douglasshop.com/mobile-apps",
        },
    ]
