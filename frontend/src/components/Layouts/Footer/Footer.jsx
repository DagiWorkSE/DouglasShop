...
const footerLinks = [
  {
    ...
    links: [
      {
        name: "Facebook",
        redirect: "https://www.facebook.com/Douglasshop",
      },
      {
        name: "Twitter",
        redirect: "https://twitter.com/Douglasshop",
      },
      {
        name: "YouTube",
        redirect: "https://www.youtube.com/Douglasshop",
      }
    ]
  }
]
      ...
      {!adminRoute && (
        <>
          ...
          <div className="px-16 py-6 w-full bg-primary-darkBlue hidden sm:flex justify-between items-center text-sm text-white">
            ...
            <span>&copy; {new Date().getFullYear()} Douglasshop.com</span>
